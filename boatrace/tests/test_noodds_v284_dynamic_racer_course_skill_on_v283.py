...
from train_noodds_v284_dynamic_racer_course_skill_on_v283 import (
...
class DynamicRacerCourseSkillOnV283Tests(unittest.TestCase):
    ...
    def test_v283_loader_preserves_parent_v280_and_v270_references(self):
        ...
        np.testing.assert_allclose(loaded["v280"], loaded["probability"])
